...
@section('content')
<div class="mg-sm">
    <form method="POST" action="{{url('/alumni')}}">
    @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input required type="text" class="form-control" name='angkatan' value="{{old('angkatan')}}">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input required type="text" class="form-control" name='no_telp' value="{{old('no_telp')}}">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input required type="text" class="form-control" name='tempat_lahir' value="{{old('tempat_lahir')}}">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input required type="text" class="date form-control"  id="datepicker" name="tanggal_lahir" value="{{old('tanggal_lahir')}}">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea required class="form-control" name="alamat" rows="3">{{old('alamat')}}</textarea>
            </div>
